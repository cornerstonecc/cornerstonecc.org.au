				...
				<div class="cover-color-overlay color-accent<?php echo esc_attr( $color_overlay_classes ); ?>"<?php echo $color_overlay_style; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- We need to double check this, but for now, we want to pass PHPCS ;) ?>></div>
					...
					<header class="entry-header has-text-align-center">
						<div class="entry-header-inner section-inner medium">
                            ...
                            // START: MALALTA CUSTOMISATION
                            ?>
                            <div class="hp-buttons">
                                <a href="#upcoming-events" class="hp-buttons__button">
                                    <span class="hp-buttons__icon dashicons dashicons-calendar-alt"></span>
                                    Upcoming events
                                </a>
                                <a href="#previous-events" class="hp-buttons__button">
                                    <span class="hp-buttons__icon dashicons dashicons-video-alt3"></span>
                                    Previous events
                                </a>
                            </div>
                            <?php
                            // END: MALALTA CUSTOMISATION
							...
							if ( is_page() ) {
                                ...
                                <?php // START: MALALTA CUSTOMISATION ?>
                                    <!--<a href="#post-inner" class="to-the-content__text">Swipe up</a>-->
                                <?php // END: MALALTA CUSTOMISATION ?>
